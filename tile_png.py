## use this specifically for images where multiple cropped regions are all on one image (versus multiple cropped regions being split up into different images)
